...
namespace AnimationTest.ECSMainThread
{
    public class TestLogic : IAsyncStartable, IDisposable
    {
        ...
        private readonly EcsAnimationMainThread _testCase;
        ...
        public TestLogic(WorldContainer worldContainer, FpsCounter fpsCounter, TestManager testManager,
            Camera mainCamera, CinemachinePositionComposer positionComposer, ITestCaseFactory<EcsAnimationMainThread> defaultFactory, IUprofWrapper uprofWrapper, TestHudLogic testHudLogic)
        {
            ...
            _testResults.TestCase = nameof(EcsAnimationMainThread);
        ...
        {
            _testHudLogic.SetTitle(nameof(EcsAnimationMainThread));
