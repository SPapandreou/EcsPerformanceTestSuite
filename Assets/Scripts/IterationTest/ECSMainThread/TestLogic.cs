...
namespace IterationTest.ECSMainThread
{
    public class TestLogic : IAsyncStartable
    {
        ...
        private readonly EcsIterationMainThread _testCase;
        private readonly TestHudLogic _testHudLogic;

        public TestLogic(TestManager testManager, IUprofWrapper uprofWrapper,
            ITestCaseFactory<EcsIterationMainThread> defaultFactory, TestHudLogic hudLogic)
        {
            ...
            _testResults.TestCase = nameof(EcsIterationMainThread);
            _testHudLogic =  hudLogic;
        }

        public async UniTask StartAsync(CancellationToken cancellation = new())
        {
            _testHudLogic.SetTitle(nameof(EcsIterationMainThread));
