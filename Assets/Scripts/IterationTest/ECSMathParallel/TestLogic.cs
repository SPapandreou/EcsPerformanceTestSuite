...
namespace IterationTest.ECSMathParallel
{
    public class TestLogic : IAsyncStartable
    {
        ...
        private readonly EcsIterationMathParallel _testCase;
        private readonly TestHudLogic _testHudLogic;

        public TestLogic(TestManager testManager, IUprofWrapper uprofWrapper,
            ITestCaseFactory<EcsIterationMathParallel> defaultFactory, TestHudLogic hudLogic)
        {
            ...
            _testResults.TestCase = nameof(EcsIterationMathParallel);
            _testHudLogic =  hudLogic;
        }

        public async UniTask StartAsync(CancellationToken cancellation = new())
        {
            _testHudLogic.SetTitle(nameof(EcsIterationMathParallel));
