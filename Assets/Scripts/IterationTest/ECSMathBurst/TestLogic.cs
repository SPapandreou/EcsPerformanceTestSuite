...
namespace IterationTest.ECSMathBurst
{
    public class TestLogic : IAsyncStartable
    {
        ...
        private readonly EcsIterationMathBurst _testCase;
        private readonly TestHudLogic _testHudLogic;

        public TestLogic(TestManager testManager, IUprofWrapper uprofWrapper,
            ITestCaseFactory<EcsIterationMathBurst> defaultFactory, TestHudLogic hudLogic)
        {
            ...
            _testResults.TestCase = nameof(EcsIterationMathBurst);
            _testHudLogic =  hudLogic;
        }

        public async UniTask StartAsync(CancellationToken cancellation = new())
        {
            _testHudLogic.SetTitle(nameof(EcsIterationMathBurst));
